...
- **Built a Kubernetes (k3s) isolation platform and handed it over** — one Job per agent execution with a dedicated namespace, ServiceAccount and RBAC, deployed declaratively via ArgoCD app-of-apps across 14 Helm charts. Verified end to end *(not production operating experience)*
