...
<div class="exp-card">
  ...
  <ul>
    ...
    <li>사내 AI 에이전트 실행 플랫폼 인프라 구축(2026.05~): 쿠버네티스 클러스터(k3s) + ArgoCD GitOps + Helm 배포, 에이전트 실행 1건 = Job 1개 격리 + egress NetworkPolicy 화이트리스트로 시크릿 반출 차단, Linkerd mTLS, self-host 레지스트리 3종</li>
