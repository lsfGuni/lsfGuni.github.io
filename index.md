...
폐쇄망 LLM 서빙 인프라부터 DDoS 3계층 방어, Blue/Green 무중단 배포까지<br>
설계·구축·운영을 단독 수행해 온 엔지니어
</p>

Spring 백엔드 개발로 시작하여 Linux 서버 구축·운영, 하이브리드 인프라, CI/CD 파이프라인 구축·개선, 모니터링·알림 체계(관측성), 보안 대응까지 확장했습니다. 장애 발생 시 근본 원인 분석(RCA) → 해결 → 고도화 → 문서화까지 이어가며, 재현 가능한 운영 체계를 만듭니다.
...
<div class="exp-card">
  ...
  <ul>
    ...
    <li>하나증권 그룹웨어 어댑터(2026.05~): 금융권 망분리 환경 SSO/DRM/인사연동 배포·장애 진단, 5개 외부 조직 기술 조율 리드</li>
...
<div id="projectAccordion">
  ...
  <div class="project-toggle" data-target="#proj-hana" aria-expanded="false">
    ...
    <p class="proj-summary">금융권 망분리·접근통제 환경에서 SSO·DRM·인사연동 어댑터 배포와 연동 장애 근본 원인 분석 담당, 5개 이상 외부 조직 간 기술 조율 리드</p>
    <div>
...
<h5>성과</h5>
  ...
  <div class="project-toggle" data-target="#proj-monitor" aria-expanded="false">
    ...
    <p class="proj-summary">모니터링·알림 체계 구축으로 관측성(Observability) 확보, 장애 인지·대응 시간 대폭 단축 + Slack 실시간 알림 운영</p>
    <div>
