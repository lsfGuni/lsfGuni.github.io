...
role: "SRE"
contribution: "100%"
summary: "AWS WAF, Nginx, iptables를 결합한 3계층 방어 아키텍처를 구축하여 비정상 트래픽을 선제 차단하고, 2일 1회 서버 중단을 장애 제로화하며 클라우드 트래픽 비용까지 절감한 프로젝트입니다."
tech:
  - AWS WAF
  - ALB
  - CloudWatch
...
- 봇/스캐너 요청 차단으로 불필요한 클라우드 트래픽 비용 절감 (비용 최적화)
