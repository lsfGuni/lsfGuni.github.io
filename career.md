...
> **월 청구 $1,497 → 약 $330 (78%↓)**.
> 후임이 정해지지 않은 상태여서 **자가복구 체계와 백업 3계층**을 만들고 문서·키·대응 절차까지 정리해 인계했습니다.
...
- **장애 대응 세트** — 시스템 상태를 한 번에 찍는 진단 스크립트와 증상별 런북 9종. 인수자가 "스캔이 안 된다" 수준으로 말해도 **사실 확보 → 원인 특정 → 조치** 순서를 밟게 구성
