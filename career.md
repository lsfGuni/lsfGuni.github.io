...
- 사내 AI 에이전트 실행 플랫폼 인프라 구축 — 쿠버네티스 클러스터(k3s), ArgoCD GitOps + Helm 배포, Job + NetworkPolicy + RBAC 기반 에이전트 격리, Linkerd mTLS, self-host 레지스트리 3종, Prometheus·Grafana·Tempo 관측성 (2026.05~, gVisor 샌드박스 전환 진행 중)
